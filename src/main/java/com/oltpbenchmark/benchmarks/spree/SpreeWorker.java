...
import com.oltpbenchmark.benchmarks.spree.procedures.SpreeProcedure;
...
public class SpreeWorker extends Worker<SpreeBenchmark> {
    ...
    public SpreeWorker(SpreeBenchmark benchmarkModule, int id,
