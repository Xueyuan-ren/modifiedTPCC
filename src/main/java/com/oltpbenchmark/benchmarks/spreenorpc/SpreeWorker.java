...
import com.oltpbenchmark.benchmarks.spreenorpc.procedures.SpreeMergedProcedure;
...
public class SpreeWorker extends Worker<SpreenorpcBenchmark> {
    ...
    public SpreeWorker(SpreenorpcBenchmark benchmarkModule, int id,
    ...
    protected TransactionStatus executeWork(Connection conn, TransactionType nextTransaction) throws UserAbortException, SQLException {
        try {
            SpreeMergedProcedure proc = (SpreeMergedProcedure) this.getProcedure(nextTransaction.getProcedureClass());
