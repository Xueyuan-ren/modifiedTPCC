...
public class DBWorkload {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (String plugin : targetList) {
            ...
            wrkld.setMergeSize(xmlConfig.getInt("mergesize", 0));
            wrkld.setItemFactor(xmlConfig.getInt("itemFactor", 1));
            wrkld.setSkewFactor(xmlConfig.getDouble("skewFactor", 0.0));
            ...
            initDebug.put("Item Factor", wrkld.getItemFactor());
            initDebug.put("Skew Factor", wrkld.getSkewFactor());
