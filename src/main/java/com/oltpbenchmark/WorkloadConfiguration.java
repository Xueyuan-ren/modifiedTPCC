...
public class WorkloadConfiguration {
    ...
    private int purgeThreadPool = 0;
    private int itemFactor = 1; // Used for item count in TPC-C
    private double skewFactor = 0.0; // Used for item distribution in TPC-C
    ...
    public int getPurgeThreadPool() {
        return purgeThreadPool;
    }
    
    public void setPurgeThreadPool(int purgeThreadPool) {
        this.purgeThreadPool = purgeThreadPool;
    }

    public int getItemFactor() {
        return itemFactor;
    }

    public void setItemFactor(int itemFactor) {
    ...
    public String toString() {
        return "WorkloadConfiguration{" +
               ...
               ", dataDir='" + dataDir + '\'' +
               ", mergeSize=" + mergeSize +
               ", purgeThreadPool=" + purgeThreadPool +
