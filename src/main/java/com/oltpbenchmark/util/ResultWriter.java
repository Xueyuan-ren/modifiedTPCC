...
public class ResultWriter {
    ...
    public void writeSummary(PrintStream os) {
        ...
        summaryMap.put("Success Latency Distribution", results.getSuccessDistributionStatistics().toSuccessMap());
        summaryMap.put("Successput (requests/second)", results.successRequestsPerSecondThroughput());
